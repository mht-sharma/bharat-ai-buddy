...
PROMPT_TEMPLATES = {
    ...
    "Default": (
        ...
        "\n4. For inquiries requiring specialized expertise beyond available knowledge domains, respond: 'This query requires specialized expertise beyond my current knowledge framework.'"
        "\n\nUser inquiry: {prompt}"
    )
}

def get_prompt(tab, prompt, language):
